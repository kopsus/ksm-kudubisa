...
const DialogLayout = ({
  ...
  return (
    <>
      ...
      {show && (
        <div
          className="fixed inset-0 z-999999 bg-black/80 pointer-events-auto"
          onClick={onHide}
        />
      )}
      ...
      <div
        ...
        } fixed left-[50%] top-[50%] z-999999 grid w-full translate-x-[-50%] translate-y-[-50%] gap-10 border border-zinc-200 bg-white p-6 shadow-lg duration-200 rounded-xl max-h-screen overflow-y-auto max-w-[425px]`}
      >
