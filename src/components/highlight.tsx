...
export const Highlight = ({ title, desc }: IHighlight) => {
  return (
    <div
    ...
    >
      ...
      <div className="relative h-[50vh] flex flex-col items-center justify-end pb-16 text-center gap-4 text-white w-1/2 mx-auto">
