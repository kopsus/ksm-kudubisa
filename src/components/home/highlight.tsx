...
export const HighlightHome = () => {
  return (
    ...
    >
      ...
      <div className="relative h-[50vh] md:h-[70vh] lg:h-screen lg:max-h-[800px] flex flex-col items-center justify-center gap-10">
        <div className="flex flex-col text-center gap-4 text-white w-1/2 mx-auto">
