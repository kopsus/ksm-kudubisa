...
export const VisiMisi = () => {
  return (
    <div className="Container">
      <div className="grid grid-cols-2 justify-center gap-10 w-10/12 mx-auto">
        <div
          className="relative bg-center bg-no-repeat h-[553px] bg-cover rounded-xl overflow-hidden"
          style={{ backgroundImage: `url(${visiIMG.src})` }}
        >
          <div className="absolute top-0 left-0 w-full h-full bg-black/50" />
          <div className="relative w-full h-full flex flex-col gap-2 justify-end p-10 text-white">
